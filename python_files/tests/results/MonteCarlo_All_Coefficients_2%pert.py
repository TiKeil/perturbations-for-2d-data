...
ROOT = '../../../test_data/MonteCarlo/Coef1/p2/0'
...
ROOT = '../../../test_data/MonteCarlo/Coef1/p2/5'
...
ROOT = '../../../test_data/MonteCarlo/Coef1/p2/10'
...
ROOT = '../../../test_data/MonteCarlo/Coef1/p2/20'
...
ROOT = '../../../test_data/MonteCarlo/Coef1/p2/30'
...
ROOT = '../../../test_data/MonteCarlo/Coef2/p2/0'
mum0, a0, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y0, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)

ROOT = '../../../test_data/MonteCarlo/Coef2/p2/5'
mum5, a5, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y5, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)

ROOT = '../../../test_data/MonteCarlo/Coef2/p2/10'
mum10, a10, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y10, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)

ROOT = '../../../test_data/MonteCarlo/Coef2/p2/20'
mum20, a20, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y20, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)

ROOT = '../../../test_data/MonteCarlo/Coef2/p2/30'
mum30, a30, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y30, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)
...
ROOT = '../../../test_data/MonteCarlo/Coef3/p2/0'
mum0, a0, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y0, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)

ROOT = '../../../test_data/MonteCarlo/Coef3/p2/5'
mum5, a5, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y5, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)

ROOT = '../../../test_data/MonteCarlo/Coef3/p2/10'
...
ROOT = '../../../test_data/MonteCarlo/Coef3/p2/20'
...
ROOT = '../../../test_data/MonteCarlo/Coef3/p2/30'
mum30, a30, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y30, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)
...
ax.semilogy(ems,plottingy,'-', label='PGLOD', linewidth = 0.4)
ax.semilogy(ems,plottingz,':r', linewidth = 0.6)

ax.semilogy(ems,plotting2x20,':b', linewidth = 0.6)
ax.semilogy(ems,plotting2y20,'-g', label='VcLod 20%', linewidth = 0.4)
...
ROOT = '../../../test_data/MonteCarlo/Coef4/p2/0'
mum0, a0, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y0, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)

ROOT = '../../../test_data/MonteCarlo/Coef4/p2/5'
mum5, a5, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y5, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)

ROOT = '../../../test_data/MonteCarlo/Coef4/p2/10'
mum10, a10, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y10, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)

ROOT = '../../../test_data/MonteCarlo/Coef4/p2/20'
mum20, a20, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y20, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)

ROOT = '../../../test_data/MonteCarlo/Coef4/p2/30'
mum30, a30, ABase, ems, plottingx, plottingy, plottingz, plotting2x, plotting2y30, plotting2z, plotting3x, plotting3y, plotting3z = regainer(ROOT)
